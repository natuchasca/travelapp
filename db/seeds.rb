...
t6 = Tag.create(title: "Cosmos", image: "http://marcaespana.es/sites/default/files/actualidad/galerias/roque-de-los-muchachos.jpg")
Destination.create(name: "Stonehenge", description: "The pits are positioned in such a way that when viewed from the 'Heel-Stone' at Stonehenge, they would have marked the rising and setting positions of the sun on the summers solstice.", image: "http://www.ancient-wisdom.com/Images/countries/English%20pics/Stonehenge.JPG", tag_id: t6.id)
Destination.create(name: "Easter Island", description: "Chilean Polynesia, is a one-of-a-kind destination whose very remoteness lends it unmistakable authenticity and an aura of mystery.", image: "http://chltvl.com/bfi_thumb/isla-de-pascua_shutterstock_77085319-mqzeyqe98hksyx54mvedrrfprxp1z7w6zmubuzodkg.jpg", tag_id: t6.id)
Destination.create(name: "Atacama Desert", description: "The incredible landscape of Chile’s remote Atacama Desert is like no place on earth, you would be forgiven for drawing comparisons with places beyond our atmosphere.", image: "https://photos.geiseres.com/actividades/tour-astronomico-id298-4.jpg", tag_id: t6.id)